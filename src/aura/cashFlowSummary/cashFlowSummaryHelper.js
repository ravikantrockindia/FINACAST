({
    doGraph : function(component, event, helper) {
        var chartDataArray = [];
        var chartLabelArray = [];
        ...
        action.setParams({
            AccountId: component.get("v.transactionId")
