({
    ...
    onload:function(component,event,helper){
       // debugger;
        ...
        if($A.util.isUndefinedOrNull(selectedAccount)||selectedAccount=="")
    ...
    onSuccessCall:function(component,event,helper){
        ...
        {
            debugger;var record = event.getParam("response");
    ...
    { 
        ...
        if ($A.util.isUndefinedOrNull(n) || n == "" ||  
            ...
            $A.util.isUndefinedOrNull(goalPriority) || goalPriority =="" || $A.util.isUndefinedOrNull(contribution) || contribution == "")
        {
            status3 = 0;
  ...
  eventFields["FinServ__TargetValue__c"] = component.find("amount").get("v.value");
    ...
    getListOfAccount : function(component,event,helper){
